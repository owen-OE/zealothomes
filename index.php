                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Making your investments and purchases secure through legal bindings. Have zero fear on what you're getting!</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="living-list pr-4">
                            ...
                            <ul>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										<h5 class="mb-3">We want to work with you</h5>
										<p>It’s a simple statement but one quite often lost in the complexities of the real estate industry. We love our work and appreciate your business.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										<h5 class="mb-3">
Local know how</h5>
										<p>We have an intimate knowledge of our area, its property and people.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									<i class="flaticon-seller flat-medium float-left d-table mr-4 text-primary" aria-hidden="true"></i>
									<div class="pl-2">
										<h5 class="mb-3">Service Guarantee</h5>
										<p>Our commitment to a successful sale of your property is guaranteed. If at any stage during the marketing of your property you are not entirely satisfied with the level of service being provided and your concerns cannot be rectified, we will be happy for you to cancel the agreement without notice</p>
									</div>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Involves the necessary talks with one of our agents regarding the kind of purchase you're intetrested in making.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>We go through the documents needed for the property acquisition process.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Congrats! You're a new house owner.</p>
                        </div>
                    </div>
                </div>
            </div>
