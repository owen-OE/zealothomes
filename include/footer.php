<footer class="full-row bg-secondary p-0">
            <div class="container">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-lg-4">
                                    <div class="footer-widget mb-4">
                                        <div class="footer-logo mb-4"> <a href="index.php"><img class="logo-bottom" src="images/logo/logo-white.png" alt="image"></a> </div>
                                        <p class="pb-20 text-white">Zealot Homes, your next rated realtors giving you the best values on porperties and land.</p>
										<p class="pb-20 text-white">We are committed to ensuring digital accessibility for individuals with disabilities. We are continuously working to improve the accessibility of our web experience for everyone, and we welcome feedback and accommodation requests.</p>
                                        </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-lg-4">
                                            <div class="footer-widget">
                                                ...
                                                <ul class="text-white">
                                                    <li class="hover-text-primary"><i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>859 Driftwood Road, Oakland, California</li>
                                                    <li class="hover-text-primary"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>+1 (434) 202-4091</li>
													<li class="hover-text-primary"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>+1 (434) 202-4091</li>
                                                    <li class="hover-text-primary"><i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>admin@zealothomes.com</li>
                                                </ul>
                                            </div>
                ...
                <div class="row copyright">
                    <div class="col-sm-6"> <span class="text-white">© 2022 ZealotHomes All right reserved</span> </div>
                    <div class="col-sm-6">
