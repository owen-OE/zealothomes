...
<!--	Title
	=========================================================-->
<title>Zealot homes | Contact</title>
</head>
<body>
                            ...
                            <ul>
                                <li class="d-flex mb-4"> <i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        ...
                                        <span class="text-secondary">859 Driftwood Road, Oakland, California</span> 
										<span class="text-secondary">859 Driftwood Road, Oakland, California</span>
										</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        ...
                                        <span class="d-table text-secondary">+1 (434) 202-4091</span>
										<span class="text-secondary">+1 (434) 202-4091 </span>
									</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">Email Adderss</h5>
										<span class="d-table text-secondary">admin@zealothomes.com</span>
										<span class="text-secondary">admim@zealothomes.com</span>
										</div>
                                </li>
                            </ul>
                        </div>
